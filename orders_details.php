...
<head>
	...
	<title>Order Details | Cookbook Ordering System</title>
	<!-- Bootstrap -->
...
<body>
	...
	try {
		...
		$stmt = $conn->prepare("SELECT * FROM tbl_orders_a181765, tbl_staffs_a181765_pt2, tbl_customers_a181765_pt2 WHERE tbl_orders_a181765.fld_staff_id = tbl_staffs_a181765_pt2.fld_staff_id AND tbl_orders_a181765.fld_cust_id = tbl_customers_a181765_pt2.fld_cust_id AND fld_order_num = :oid");
...
<div class="container-fluid">
    ...
    <hr>
      ...
      <table class="table table-striped table-bordered">
		...
		<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="margin-bottom: 30px;">
